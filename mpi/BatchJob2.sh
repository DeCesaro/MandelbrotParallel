...
echo #################
echo "-----------NPOINTS-500-2----------------"
mpirun --bynode -np 2 ./atividade500
echo "-----------NPOINTS-1000-2--------------"
mpirun --bynode -np 2 ./atividade1000
echo "-----------NPOINTS-1500-2--------------"
mpirun --bynode -np 2 ./atividade1500
echo "-----------NPOINTS-2000-2--------------"
mpirun --bynode -np 2 ./atividade2000
echo "-----------NPOINTS-2500-2--------------"
mpirun --bynode -np 2 ./atividade2500
echo "-----------NPOINTS-3000-2--------------"
mpirun --bynode -np 2 ./atividade3000
echo "-----------NPOINTS-3500-2--------------"
mpirun --bynode -np 2 ./atividade3500
echo "-----------NPOINTS-4000-2--------------"
mpirun --bynode -np 2 ./atividade4000
echo "-----------NPOINTS-4500-2--------------"
mpirun --bynode -np 2 ./atividade4500
echo "-----------NPOINTS-5000-2--------------"
mpirun --bynode -np 2 ./atividade5000
echo "-------------------------------------------------"
echo "-----------NPOINTS-500-4----------------"
